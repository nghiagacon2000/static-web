...
<body>
    ...
    <section id="home" class="hideable-section">
        <div class="content1">
            <div class="container1">
                <h1>dịch vụ nso</h1>
                <div>
            <a href=""><img src="./img/anhso1.png"></a>		
                    <p>nạp thẻ</p>
                </div>   	 	
             <div>
            <a href=""><img src="./img/anhso2.jpg"></a>		
                    <p>up thuê</p>
                </div>   	 	
             <div>
            <a href=""><img src="./img/anhso3.jpg"></a>		
                    <p>bán xu tự động</p>
                </div>   	
             <div>
            <a href=""><img src="./img/anhso4.jpg"></a>	
       ...
       <div class="b" >
        <div class="column" id="a" >
             <a href=""><img src="./img/anhso2.png" ></a>	
        ...
        <div class="b" >
            <div class="column" id="a" >
                 <a href=""><img src="./img/anhlienquan.png" ></a>	
            ...
            <div class="b" >
                <div class="column" id="a" >
                     <a href=""><img src="./img/anhlangla.png" ></a>	
                ...
                <div class="b" >
                    <div class="column" id="a" >
                         <a href=""><img src="./img/anhngocrong.png" ></a>	
    ...
    <section id="services" class="hideable-section">
        ...
        <div class="container">
              <div class="thongbao" >
                ...
                <br>
                <br>
                <img src="./img/ninja.jpg" style="width:90%;height:400px ;" alt="">
    ...
    <section id="link1" class="hideable-section">
        <div style="line-height: 1.42857;">
           <center><h1 style="color: #3f444a;">DỊCH VỤ NẠP XU</h1></center>
            <div class="column1">
                <img src="./img/anhlangla.png" style="width:20%" alt="">
            <center>
            </div>
            <div class="column1">
    ...
    <section id="link2" class="hideable-section">
        <div>
            <div class="column1">
                <img src="./img/anhngocrong.png" style="width:30%;" alt="">
